...
function fetch_wordpress_data() {
	...
	if(creds.colocated) {
		...
		run("/usr/bin/php /home3/thecdeor/wp-cli.phar export --skip_comments --stdout > wordpress-data/wordpress.xml")
		run("/usr/bin/php /home3/thecdeor/wp-cli.phar option get tablepress_tables > wordpress-data/tablepress_tables.json")
...
function fetch_google_fonts() { 
	run("npx goofoffline outDir=public/fonts \"https://fonts.googleapis.com/css?family=Roboto+Condensed:400\" \"https://fonts.googleapis.com/css?family=Open+Sans:400,600\"")
}
